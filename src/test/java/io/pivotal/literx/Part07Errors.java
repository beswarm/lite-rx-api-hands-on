...
//========================================================================================
    ...
    Mono<User> betterCallSaulForBogusMono(Mono<User> mono) {
        return FluxSource.wrap(mono).onErrorReturn(IllegalStateException.class, User.SAUL).single();
    }
...
//========================================================================================
    ...
    Flux<User> betterCallSaulAndJesseForBogusFlux(Flux<User> flux) {
        return flux.onErrorResumeWith(IllegalStateException.class, e -> Flux.just(User.SAUL, User.JESSE));
    }
